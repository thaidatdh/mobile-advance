...
const english = {
  ...
  SeeAll: "See All",
  Internet: "Internet",
  NoInternetAlert: "This application require internet connection.\nYou may not use all feature with offline mode.",
  Profile: "Profile",
  SignIn: "Sign In",
  SignUp: "Sign Up",
  ...
  Keepyourskilluptodate: "Keep your skill up-to-date with access to thousands of courses by industry experts.",
  ...
  Alert: "Alert",
  Youhavetoownedcoursetowatchthislesson: "You have to owned course to watch this lesson!",
  Cannotseethisvideobecauseitsaonlinesection: "Cannot see this video because it's a online section.",
  ...
  Pleaseenterdifferentemailtochangeemail: "Please enter different email to change email",
  ...
  Sorryweneedpermissionstomakethiswork: "Sorry, we need permissions to make this work",
...
const vietnamese = {
  ...
  Keepyourskilluptodate: "Cập nhật kỹ năng của bạn với hàng ngàn khoá học của các chuyên gia.",
  ...
  Cannotseethisvideobecauseitsaonlinesection: "Không thể xem vì là phần online. Cần Internet.",
  ...
  Sorryweneedpermissionstomakethiswork: "Ứng dụng cần quyền truy cập để thực hiện hành động",
